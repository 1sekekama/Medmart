...
>
  <div
    class="relative mx-4  mt-[7rem] mb-8 grid h-28 place-items-center overflow-hidden rounded-xl bg-gradient-to-tr from-cyan-600 to-cyan-400 bg-clip-border text-white shadow-lg shadow-cyan-500/40"
  >
    <h3
  ...
  <div class="p-6 pt-0">
    ...
    >
      ...
      <a href="/SignUp" class="ml-1 block font-sans text-sm font-bold leading-normal text-cyan-500 antialiased"
